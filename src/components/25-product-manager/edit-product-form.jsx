...
const EditProductForm = ({ setOp, setCreated, currentProductId }) => {
  ...
  useEffect(() => {
    const loadProduct = async () => {
      try {
        const data = await fetchProduct(currentProductId);
  ...
  return (
    <Card className="mb-4 position-sticky top-0 z-3">
      <Card.Body>
